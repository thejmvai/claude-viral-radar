  ...
  <div class="reel">
    ...
    <div class="right">
      ...
      <div class="chips">
        ...
        <span class="chip date">${esc(r.postedAt)}</span>
      </div>
      <div class="qrow">
...
<body><div class="wrap"><div class="pglabel">Viral Radar &middot; ${esc(ds.label || ds.niche)}</div>
...
.wrap{max-width:1120px;margin:0 auto;padding:46px 40px 90px}.pglabel{font-size:12px;font-weight:600;letter-spacing:.05em;color:var(--red);text-transform:uppercase;margin-bottom:24px}
...
.chips{display:flex;flex-wrap:wrap;gap:9px;margin-bottom:8px}.chip{display:inline-flex;align-items:center;gap:7px;font-family:var(--mono);font-size:13px;background:var(--card-2);border:1px solid var(--border);border-radius:9px;padding:6px 12px}.chip svg{width:14px;height:14px}.chip.eye svg{color:var(--muted)}.chip.heart svg{color:var(--heart)}.chip.cmt svg{color:var(--muted)}.chip.date{color:var(--muted)}.chip.hot{background:var(--red-bg);border-color:var(--red-bd);color:#FF8E62;font-weight:600}.chip.hot svg{color:var(--fire)}
